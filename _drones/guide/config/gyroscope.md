...
1. Click the **Gyroscope** sensor button
   ...
   ![Select Gyroscope calibration PX4](images/drones/qgc/setup/sensor/gyroscope_calibrate_px4.jpg)
1. Place the vehicle on a surface and leave it still.
1. Click **Ok** to start the calibration.

   The bar at the top shows the progress:
   
   ![Gyro calibration in progress on PX4](images/drones/qgc/setup/sensor/gyroscope_calibrate_progress_px4.jpg)
1. When finished, *QGroundControl* will display a progress bar *Calibration complete* 
   ![Gyro calibration complete on PX4](images/drones/qgc/setup/sensor/gyroscope_calibrate_complete_px4.jpg)
