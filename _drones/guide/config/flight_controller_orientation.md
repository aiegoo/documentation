...
<img src="images/drones/qgc/setup/sensor/fc_orientation_1.png" style="width: 600px;"/>
...
![Yaw Rotation](images/drones/qgc/setup/sensor/yaw_rotation.png)
...
1. Select the **Set Orientations** button.
   <img src="images/drones/qgc/setup/sensor/sensor_orientation_set_orientations.jpg" style="width: 600px;"/>
1. Select the **AutoPilot Orientation** (as [calculated above](#calculating-orientation)).

   <img src="images/drones/qgc/setup/sensor/sensor_orientation_selector_values.jpg" style="width: 200px;"/>
