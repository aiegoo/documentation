...
1. Open the *QGroundControl* **Settings > Power**, then press the **Calibrate** button.
   ...
   ![ESC Calibration step 1](images/drones/qgc/setup/esc/qgc_esc_calibration.png)

1. Connect the battery when prompted:

   ![ESC Calibration step 2](images/drones/qgc/setup/esc/esc_calibration_step_2.png)

   The calibration will begin automatically:

   ![ESC Calibration step 3](images/drones/qgc/setup/esc/esc_calibration_step_3.png)

1. Once the calibration complete you will be prompted to disconnect the battery.

   ![ESC Calibration step 4](images/drones/qgc/setup/esc/esc_calibration_step_4.png)
