...
![Trigger pins](images/drones/camera/trigger_pins.png)
...
![Seagull SYNC#2](images/drones/peripherals/camera_capture/seagull_sync2.png)
...
1. From *QGroundControl*:
   ...
   ![QGC Test Camera](images/drones/camera/qgc_test_camera.png)

## Sony QX-1 example (Photogrammetry)

![photogrammetry](images/drones/camera/photogrammetry.png)
...
![QGC Survey Polygon](images/drones/camera/qgc_survey_polygon.jpeg)

![QGC Survey Parameters](images/drones/camera/qgc_survey_parameters.jpg)

### Geotagging

Download/copy the logfile and images from the flight and point QGroundControl to them. Then click on "Start Tagging".

![QGC Geotagging](images/drones/camera/qgc_geotag.png)
...
![GeoTag](images/drones/camera/geotag.jpg)
...
![Sequence diag](images/drones/camera/sequence_diagram.jpg)
