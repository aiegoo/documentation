...
![QAV250 - Complete build with pixhawk mini](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_complete_build_with_pixhawk_mini.jpg)

![QAV250 - Complete build with pixhawk mini and props](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_complete_build.jpg)
...
![Hardware for QAV250 frame](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_framehardware_displayall.jpg)
...
![QAV250/PixhawkMini Electronics before assembly](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_pixhawk_mini_electronics_unassembled.jpg)
...
![3DR Telemetry Radio Kit - unboxed](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/3dr_telemetry_radio_kit.jpg)
...
![Tools required for assembling QAV250](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_pixhawk_mini_assembly_tools_needed.jpg)
...
![Add standoffs and screws to PDB](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_frame_assembly_1_pdb_standoffs.jpg)

**Step 2:** Place the frame on the standoffs.

![Place frame on top of standoffs (on top of PDB)](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_frame_assembly_frame_with_pdb_no_standoffs.jpg)

:::note
Ensure that you have the frame-plate mounted the correct way.
The cut indicated below shows the bottom of the frame.
![Diagram indicating which side is bottom of QAV250 frame plate](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_frame_assembly_indicate_bottom_of_frame.jpg)
:::

**Step 3:** Put the 35mm standoffs on the screws (you will need 2.0mm Hex screwdriver).

![Place standoffs on top of frame](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_frame_assembly_frame_on_pdb_standoffs.jpg)

**Step 4:** Attach the camera plate and add remaining standoffs.

![Add camera place and remaining standoffs to the frame.](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_frame_assembly_camera_plate_and_remaining_standoffs.jpg)

**Step 5:** Place the flight controller cover plate on the standoffs and screw into place.

![Attach flight controller cover plate](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_frame_assembly_add_flight_controller_cover_plate.jpg)
...
![Add motors to QAV250 frame](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_add_motors.jpg)
...
![Solder ESC to QAV250 PDB](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_solder_esc_pdb.jpg)
...
![Solder power module to QAV250 pdb](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_solder_power_module_to_pdb.jpg)
...
![Solder LEDS to QAV250 PDB](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_solder_leds_to_pdb.jpg)
...
![Solder motors to ESC.](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_solder_motors_to_esc.jpg)

:::note
Once the cables are soldered in the correct order, cover the pads with electrical tape or tubing.
![Cover ESC in tape for safety](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_esc_covered_in_tape_for_safety.jpg)
:::
...
![Attach wired PDB to frame on QAV250](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_finished_pdb_attach_frame.jpg)

**Step 7:** Attach the LEDs to the frame using the Phillips screws provided.

![Attach LEDS to frame](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_attach_LEDs_to_frame.jpg)

:::warning
The carbon fiber is conductive use silicon to avoid the contact with the weld in the frame.
![Use silicon to isolate LEDs from frame](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_use_silicon_with_leds.jpg)
:::
...
![Add damping foam to frame (for Pixhawk)](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_attach_pixhawk_damping_foam.jpg)
...
![Attach Pixhawk Mini on top of damping foam](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_attach_pixhawk_mini.jpg)
...
![Connect the Pixhawk Mini to the power module](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_connectpowermodule.jpg)
...
![Connect Pixhawk to QAV250 ESCs using PWM Board](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_connect_pwm_board_escs.jpg)
![Connect Pixhawk to QAV250 ESCs using PWM cable](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_connect_pixhawk_to_esc_via_pwm_cables.jpg)

**Step 12:** Connect the receiver

Connect the *FRSky D4-R* receiver channel 1 to the **RCIN** port on the *Pixhawk Mini* (as shown).

![Connect FRSKY](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_connect_frsky_rc_reciever.jpg)
...
![Connect GPS to Pixhawk Mini](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_connect_gps_to_pixhawk_mini.jpg)
...
![Mount GPS on QAV250](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_mount_gps.jpg)
...
![Connect 3DR Wifi Telemetry Radio Kit to Pixhawk Mini](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_pixhawk_mini_to_telemetry_radio_connections.jpg)
...
![Mount 3DR Wifi Telemetry Radio Kit to QAV250](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_mount_telemetry_radio.jpg)

**Step 16:** Attach landing standoffs to the arms

![QAV250 Landing Standoffs](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_landing_standoffs.jpg)
...
![QAV250 with battery foam and velcro strap](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_battery_foam_and_velcro_strap.jpg)
...
![QGroundControl - Update firmware](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qgc_firmware_menu.png)

**Step 2:** Select the airframe (**Quadrotor x > Lumenier QAV250**).

Then click **Apply and Restart**.

![QGroundControl - Select firmware to update](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_qgc_firmware.png)
...
![QGroundControl - Radio Calibration](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qgc_radio_calibration.jpg)
...
![QGroundControl - Calibrate Sensors](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qgc_calibrate_sensors.png)
...
![QGroundControl - Set flight modes](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qgc_flight_mode_selection_qav250.png)
...
3. Select the **Calibrate **button and then follow the on-screen instructions (Connect your battery.
   ...
   ![QGroundControl - Calibrate ESCs](images/drones/qgc/setup/esc/qgc_esc_calibration.png)

   ![QGroundControl - Calibrate ESCs](images/drones/qgc/setup/esc/qgc_esc_calibration_power.png)
...
![Recommended parameters for QAV250](images/drones/airframes/multicopter/lumenier_qav250_pixhawk_mini/qav250_recommended_parameters.jpg)
