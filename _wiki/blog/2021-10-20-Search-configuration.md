...
tags: [jekyll]
permalink: 2021-10-20-Search-configuration.html
sidebar: other_sidebar
folder: blog
collection: wiki
categories: jekyll
keywords: "search json configuration search-container input focus"
summary: "Wed, Oct 20, 21, The search feature uses JavaScript to look for keyword matches in a JSON file. The results show instant matches, but it doesn't provide a search results page like Google. Also, sometimes invalid formatting can break the JSON file."
excerpt_separator: <!--more-->
toc: true
public: true
parent: [[Wiki-Setting-Category]] 
date: 2021-10-20T13:10:57 +0900
updated: 2021-10-20 13:10
---
* TOC
{:toc}

## search-configuration.md retake
