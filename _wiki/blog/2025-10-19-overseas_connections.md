---
layout: post
title: "Two Years of Building International Tech Connections: A Developer's Initiative"
name: "overseas_connections"
tags: [likelion, development, international, strategic-planning]
tagName: likelion
permalink: 2025-10-19-overseas_connections.html
sidebar: other_sidebar
folder: blog
collection: wiki
categories: wiki
keywords: "poland indonesia thailand malaysia brazil great-britan kazhastan development strategic-planning"
summary: "Sun, Oct 19, 25, How a head of strategic planning division initiated international tech connections for a company that had no prior overseas experience"
excerpt_separator: <!--more-->
toc: true
public: true
parent: [[Wiki-Setting-Category]] 
date: 2025-10-19T15:18:56 +0900
updated: 2025-10-19 15:18
---
* TOC
{:toc}

{{site.data.alerts.callout_warning}}This documents the process of establishing international tech connections for a company with no prior overseas experience.{{site.data.alerts.end}}
...
{% include callout.html content="This was our company's first significant international technology partnership, requiring us to adapt our development processes to automotive industry standards." type="info" %}
...
{% include google_drive_folder_embed.html folder_id="13lEI2q-TSuRjFczcjYE5p5zBTMjLmCb8" %}
...
{% include image.html file="bms/know-how.png" alt="Dataset Analysis Results" caption="Comprehensive analysis results showing battery performance patterns and AI model predictions" %}
...
{% include callout.html content="Building international technology connections from zero expanded our development capabilities and opened access to global technology markets that were previously unavailable to our company." type="info" %}
