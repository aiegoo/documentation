---
name: "쇼핑할 맛이 나게 하는 '추천'"
layout: post
permalink: 2021-10-04-wiki-recopic.html
...
{% include image.html file="assets/post/002/208_01.png" caption="메인홈과 검색결과, 상세페이지에서의 추천" %}
...
(더 읽기: 티몬 User Segment에 따른 검색결과 조정 → [서비스 제작과정을 통해 알아보는 서비스 기획](2021-10-04-wiki-tmong.md)

{% include image.html file="assets/post/002/208_02.png" caption="고객과 고객간의 연관성, 상품과 상품간의 연관성, 고객과 상품간의 연관성을 바탕으로 추천서비스를 구현하는 레코벨" %}

{% include image.html file="assets/post/002/208_03.png" caption="고객의 소비여정을 반영한 레코픽의 추천상품 유형" %}
...
{% include image.html file="assets/post/002/208_04.png" caption="롯데닷컴(왼쪽)과 원데이텐미닛(오른쪽)" %}
