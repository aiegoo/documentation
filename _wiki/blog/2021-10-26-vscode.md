---
layout: post
title: "VSCODE as IDE for PX4 devworks"
name: "vscode to replace qt5-creator"
tags: [gcs]
tagName: gcs
permalink: 2021-10-26-vscode.html
sidebar: other_sidebar
folder: blog
collection: wiki
categories: drone
keywords: "qt creator debug px4 firmware IDE"
summary: "a powerful cross-platform source code editor/IDE that can be used for PX4 development on Ubuntu 18.04 LTS and macOS (Windows support coming soon"
excerpt_separator: <!--more-->
toc: true
public: true
parent: [[Wiki-Setting-Category]] 
date: 2021-10-26T20:25:15 +0900
updated: 2021-10-26 20:47
---
* TOC
{:toc}
...
:::tip
{% include callout.html content="***tip*** To see the `jlink` option you must have selected a [cmake target for building firmware](#building-px4)." type="success" %}
:::
