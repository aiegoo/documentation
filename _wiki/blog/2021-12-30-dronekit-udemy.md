...
{% include audio.html src="resources/audio/stm32/stm3202-poweringup.mp3" %}
{% include audio.html src="resources/audio/stm32/stm3202a-tone.mp3" %}
{% include audio.html src="resources/audio/stm32/stm3203a-communication.mp3" %}
***section3***
{% include audio.html src="resources/audio/stm32/stm3203b-bno080.mp3" %}
{% include audio.html src="resources/audio/stm32/stm320513-icm.mp3" %}
{% include audio.html src="resources/audio/stm32/stm320621-lps22hh.mp3" %}
***section4***
{% include audio.html src="resources/audio/stm32/stm320722-ublox.mp3" %}
{% include audio.html src="resources/audio/stm32/stm320823-m8n.mp3" %}
{% include audio.html src="resources/audio/stm32/stm320931-ubx1.mp3" %}
{% include audio.html src="resources/audio/stm32/stm321032-ubx2.mp3" %}
{% include audio.html src="resources/audio/stm32/stm321133-writingm8n.mp3" %}
***section5***
{% include audio.html src="resources/audio/stm32/stm321234-flyskysetup.mp3" %}
{% include audio.html src="resources/audio/stm32/stm321335-busmessage.mp3" %}
{% include audio.html src="resources/audio/stm32/stm321441-busparsing.mp3" %}
{% include audio.html src="resources/audio/stm32/stm321542-busfailsafe.mp3" %}
{% include audio.html src="resources/audio/stm32/stm321643-busfailsafe.mp3" %}
***section6***
{% include audio.html src="resources/audio/stm32/stm321744-dronehw.mp3" %}
***section7***
{% include audio.html src="resources/audio/stm32/stm321845-escprotocol.mp3" %}
{% include audio.html src="resources/audio/stm32/stm321950-oneshot125.mp3" %}
{% include audio.html src="resources/audio/stm32/stm322061-esccalibration.mp3" %}
{% include audio.html src="resources/audio/stm32/.mp3" %}
{% include audio.html src="resources/audio/stm32/stm322162-enteringoptional.mp3" %}
***section8***
{% include audio.html src="resources/audio/stm32/stm322263-readwrite.mp3" %}
{% include audio.html src="resources/audio/stm32/stm322364-eepromdata.mp3" %}
{% include audio.html src="resources/audio/stm32/.mp3" %}
{% include audio.html src="resources/audio/stm32/stm322471-voltagecheck.mp3" %}
{% include audio.html src="resources/audio/stm32/stm322572-bno080.mp3" %}
{% include audio.html src="resources/audio/stm32/stm322673-icm20602.mp3" %}
***section9***
{% include audio.html src="resources/audio/stm32/stm322774-3drradiotelemetry.mp3" %}
{% include audio.html src="resources/audio/stm32/stm322875-gcs.mp3" %}
{% include audio.html src="resources/audio/stm32/stm322981.mp3" %}
{% include audio.html src="resources/audio/stm32/stm323082.mp3" %}
{% include audio.html src="resources/audio/stm32/stm323183.mp3" %}
{% include audio.html src="resources/audio/stm32/stm323284a.mp3" %}
{% include audio.html src="resources/audio/stm32/stm323284a.mp3" %}
{% include audio.html src="resources/audio/stm32/.mp3" %}
{% include audio.html src="resources/audio/stm32/stm323284a.mp3" %}
{% include audio.html src="resources/audio/stm32/stm323284a.mp3" %}
...
#### video 7
- ICM 20602 gyro SPI 2-2강. 6축 센서 인터페이스(3축 각속도 계산)

```
- 전체 시스템 타임라인

- BNO080 센서의 인터페이스 및 3축 회전 각도 계산에 걸리는 시간

​

- ICM-20602 6축 센서 Overview

- ICM-20602 vs MPU-6000/6050 자이로스코프 비교

- ICM-20602 vs MPU-6000/6050 가속도센서 비교

- ICM-20602 의 자이로 및 가속도 최대 출력 주기

- ICM-20602 의 자이로 및 가속도 내부 DLPF 설정

- ICM-20602 인터페이스 (SPI통신)

- ICM-20602 회로 및 핀 설명

- ICM-20602 SPI 파라미터 설명

​

※ 아래 내용부터는 유료로 시청하실 수 있습니다.

- CubeMX SPI1 설정

- ICM-20602 센서 오픈소스 라이브러리 다운로드 방법 및 설명 (STM32F4 SPI LL드라이버용)

- ICM-20602 초기화 소스코드 작성 (오픈소스 사용)

- ICM-20602 센서 초기화 코드 설명 (오픈소스 사용)

- ICM-20602 자이로 센서 raw 데이터 수신 및 출력 (오픈소스 사용)

- ICM-20602 각속도 단위(Degree/Sec)로 변환

- 3축 회전 각속도 출력 (텍스트, 그래프, printf 함수 사용)

- ICM-20602 센서 출력 주기 확인 - 1kHz

- ICM-20602 센서의 인터페이스 및 3축 각속도 계산에 걸리는 시간
```
