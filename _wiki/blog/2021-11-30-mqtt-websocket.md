...
My question was how to push data from a webserver to mobile app. There are various methods of pushing in this regard;
...
- 100자 미만의 메세지 포함 가능
- 수초 정도의 delay 상관없음.
- client는 c/c++ 기반 mobile app or native webapp
