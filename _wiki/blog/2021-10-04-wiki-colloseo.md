...
collection: wiki
summary: "추천의 원리 더 깊게 보기 클러스터링, 협업필터링, 프로파일링"
tags: [wiki, ai]
excerpt_separator: <!--more-->
date: 2021-10-04 21:14:03 +0900
...
{% include image.html file="assets/post/002/209_01.png" caption="flowchart 연관성" %}
...
{% include image.html file="assets/post/002/209_02.png" caption="앤아더스토리즈의 사이즈가이드(왼쪽), 네이버쇼핑 전시상품 마네킹(오른쪽)" %}

위 모델링 과정에 쓰인 알고리즘은 이렇다. 신체 사이즈 데이터가 들어왔을 때 가슴둘레가 76 이하이면 32, 76과 80 사이면 34, 80과 84 사이면 36, 84와 88 사이면 38 등의 신체사이즈로 단순화된다.


{% include image.html file="assets/post/002/209_03.png" caption="가슴둘레만 반영" %}
---
...
{% include image.html file="assets/post/002/209_04.png" caption="분류(왼쪽)과 클러스터링(오른쪽)" %}
![](/assets/images/post/002/209_04.png)
...
{% include image.html file="assets/post/002/209_05.png" caption="협업필터링에 의한 추천상품" %}
...
![](/assets/images/post/002/209_06.png)
{% include image.html file="assets/post/002/209_06.png" caption="스포티파이의 프로파일링 지표들" %}
...
{% include image.html file="assets/post/002/209_09.png" caption="스포티파이의 노래 추천 프로세스" %}
