---
layout: post
title: "Workflow and Architecture of AI modles on Edge devices using FPGA"
name: "fpga-ai"
tags: [fpga]
tagName: fpga
...
## FPGA AI
{% include image.html file="llm/aieot/fpga_board.png" caption="AMD develop board Xilinx Nexys A7" %}
{% include image.html file="llm/aieot/edgeTree.png" caption="where and what are running to enable AI" %}
...
{% include image.html file="llm/aieot/vpBasedDesignFlow.png" caption="deploying AI models at the edge" %}
