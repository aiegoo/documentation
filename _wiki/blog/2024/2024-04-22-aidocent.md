...
| [q&aDataset](https://docs.google.com/spreadsheets/d/1UFqYntXEl5NkCUKuNfOowCKNDgDCWerB8kch5xf-xyc/edit#gid=0) | [projectBlog](https://pf7.eggs.or.kr/2024-04-22-aidocent.html)

### AWS server
[WindowsServer](13.239.112.86) port:   [itsInstance](https://ap-southeast-2.console.aws.amazon.com/systems-manager/session-manager/i-0871c9912e7cb2174?region=ap-southeast-2#) accessible only via aws console

{% include image.html file="images/nlp/windowsServerAWS.jpg" caption="AWS Windows Server to run Jmeter to LLM application on the cloud" %}
