...
|---
| Introduction | DIY dorne hardware overview control demo
| Video steaming and fron-end control | Environment setup
| Raspi hardware/network setup | Java initial app layout
| Java logging setup async | Python intial app layout
| raspi as linux service | Configuration reader setup
| video stereaming app | Html video page
| Js video stream client | java home controller video endpoint
| java configuration reader | java web-socker config
...
| Python boostraping initial app | Python Network connection monitoring
| Python data receiver thread | Python drone object vehicle abstraction
| Python network messages econding | Python drone control panel object
| Python maintaining constant spped and direction | Python camera serve controlling thread 
| Python camera server control | Python finished application logic 
| Final result full distributed application | realword flight demo
### code example
