...
{{site.data.alerts.callout_warning}}This is a draft, the content is not complete and of poor quality!{{site.url}}data.alerts.end}}

***ref*** [qt5-creator]({{site.2021-10-26-qt5-creator.html)
### Qt Creator IDE
 [youtube](https://resources.qt.io/learning-hub/introduction-to-qt-installing-qt-creator)
:::warning
