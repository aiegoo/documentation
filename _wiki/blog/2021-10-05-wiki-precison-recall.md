---
name: "precison recall"
layout: post
permalink: 2021-10-05-wiki-precison-recall.html
sidebar: other_sidebar
collection: wiki
summary: "학습한 모델 평가 기준"
tags: [wiki, python]
excerpt_separator: <!--more-->
date: 2021-10-05 08:44:03 +0900
updated: 2021-10-05 8:59 PM
toc: true
public: true
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_classification_1.jpg" caption="classification" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_classification_2.png" caption="classification" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_classification_3.png" caption="classification" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_classification_4.png" caption="classification" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_classification_5.png" caption="classification" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_classification_6.png" caption="classification" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_roc_1.png" caption="classification" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_roc_2.png"  caption="classification" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_object_detection_1.jpg" caption="detection" %}

정답은 4개 입니다. 앞 예제와 동일하게 색상은 쉽게 구분이 되도록 맞춘 것뿐이니 신경쓰지 않으셔도 됩니다. 우리가 평가할 모델이 여섯 개이고, 각 모델의 결과가 다음과 같다고 가정해봅시다.

{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_object_detection_2.png" caption="detection" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_object_detection_3.png" caption="detection" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_object_detection_4.png" caption="detection" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_object_detection_5.png" caption="detection" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_prg_1.png" caption="detection" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_prg_2.png" caption="detection" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_segmentation_1.png"  caption="segmentation" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_segmentation_2.png"  caption="segmentation" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_segmentation_3.png"  caption="segmentation" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_segmentation_4.png"  caption="segmentation" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_segmentation_7.png"  caption="segmentation" %}
...
{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_segmentation_5.png"  caption="segmentation" %}

앞서 살펴본 4가지 평가 기준에 대해서 정리해봤습니다.

{ % include image.html file="warehouse/2017-5-22-Evaluation_Talk_segmentation_6.png"  caption="segmentation" %}
