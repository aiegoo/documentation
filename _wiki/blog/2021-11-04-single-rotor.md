...
| | |
| -- | -- |
| [report](https://github.com/aiegoo/single-rotor/blob/master/report.pdf) | [sr-vtol]({{site.github_link}}pdf/sr-vtol.pdf) | [helicopter]({{site.github_link}}pdf/helicopter.pdf)
...
{% include image.html links="https://github.com/aiegoo/single-rotor/blob/master/Images/finalmodel.jpg" %}
