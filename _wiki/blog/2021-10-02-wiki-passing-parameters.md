---
name: liquid passing parameters
layout: post
...
<a href="#mydoc/alerts.md" title="mydoc_alerts">[mydoc_alerts](mydoc/alerts.md) also uses the same logic by inserting contents within the bootstrap box.</a>
