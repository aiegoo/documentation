...
$(".tabs > li").click(function(){
	...
	$(".conts").eq(n).show(0, function(){
		...
		$.ajax({
			...
			//https://api.openweathermap.org/data/2.5/forecast?id=183329&appid=02efdd64bdc14b279bc91d9247db4722&units=metric 		//weekly
			data: {
				id: "1835848",
...
function dailyFn(data) {
	...
	$("#wt_coord").html("위도: "+data.coord.lat+" / 경도: "+data.coord.lon "-" +data.main.name);
}
