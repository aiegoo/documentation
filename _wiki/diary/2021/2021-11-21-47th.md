...
.tabs {border-bottom:1px solid #999; position:absolute; top:11.2%; left:6.13%; width:63%;}
...
.conts {width:96%; height:100%; overflow-y:auto; position:absolute;     font-size: 11px; margin-top: 16px; }
.daily {display:block;}
.weekly {display:none;}
