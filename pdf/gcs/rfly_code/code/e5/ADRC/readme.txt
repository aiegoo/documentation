ADRC law is greatly affected by the execution frequency of the controller. HIL simulation cannot reflect the actual flight performance due to its unstable execution frequency. 
The parameters in 'FLY' are tested on a real aircraft, but when you apply them to your own aircraft, you need to re-turn. 
