...
%parameters in adrc
SL_TD_R = Pixhawk_CSC.Parameter({single(20), 'SL_TD_R'});
SL_TD_H = Pixhawk_CSC.Parameter({single(1), 'SL_TD_H'});
SL_NLSEF_R = Pixhawk_CSC.Parameter({single(200), 'SL_NLSEF_R'});
SL_NLSEF_H = Pixhawk_CSC.Parameter({single(25), 'SL_NLSEF_H'});
SL_NLSEF_C = Pixhawk_CSC.Parameter({single(5), 'SL_NLSEF_C'});
SL_ESO_B01 = Pixhawk_CSC.Parameter({single(250), 'SL_ESO_B01'});
SL_ESO_B02 = Pixhawk_CSC.Parameter({single(2000), 'SL_ESO_B02'});
SL_ESO_B03 = Pixhawk_CSC.Parameter({single(3000), 'SL_ESO_B03'});
SL_ESO_B0 = Pixhawk_CSC.Parameter({single(47.4), 'SL_ESO_B0'});
SL_ESO_H = Pixhawk_CSC.Parameter({single(1), 'SL_ESO_H'});
SL_ESO_D = Pixhawk_CSC.Parameter({single(0.01), 'SL_ESO_D'});
