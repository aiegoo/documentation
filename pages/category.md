...
{% for page in site.pages %}
  ...
  {% capture category-item %}{{ page.categories | first }}{% endcapture %}
<h6 class="post-meta category-h6 category" id="{{ category-item }}"> {{ category-item }} &#8672; {{ page[category-item].url }} </h6>
<ul class="topics">
